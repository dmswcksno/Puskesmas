  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="AntrianUser">Antrian <span class="sr-only">(current)</span></a>
      </li>
   ...
   <main role="main" class="container">
      <a href="<?php echo base_url('index.php/AntrianUser/create') ?>" class="btn btn-primary my-3">Tambah</a>
      <table class="table table-hover">
        ...
        <tbody>
          <?php foreach ($antrian_list as $key => $value): ?>
            <tr>
              ...
              <td> -->
             <!--    <td>
                <a href="<?php echo base_url("index.php/Antrian/update/".$value['id']) ?>" class="btn btn-sm btn-success">Edit</a>
                <a href="<?php echo base_url("index.php/Antrian/deleteData/".$value['id']) ?>" class="btn btn-sm btn-danger">Hapus</a>
              </td> -->
            </tr>
