...
<html lang="en">
  ...
  <?php echo form_open('antrian/update/'.$this->uri->segment(3)); ?>
  <legend>Edit Data Pegawai</legend>
  <?php echo validation_errors(); ?>
  <div class="form-group">
    <label for="">Nama</label>
    <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $antrian[0]->nama ?>" placeholder="Input field">
  </div>
  <div class="form-group">
    <label for="">alamat</label>
    <input type="text" class="form-control" name="alamat" id="alamat" value="<?php echo $antrian[0]->alamat ?>" placeholder="Input field">
  </div>
   <div class="form-group">
    <label for="">No Telpon</label>
    <input type="text" class="form-control" name="notlp" id="notlp" value="<?php echo $antrian[0]->notlp ?>" placeholder="Input field">
  </div>
